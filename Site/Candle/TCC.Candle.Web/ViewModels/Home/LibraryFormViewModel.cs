...
{
    public class LibraryFormViewModel
    {
        public LibraryFormViewModel()
        {

        }
        public LibraryFormViewModel(LibraryFormDto dto)
        {
            Title = dto.Title;
        ...
        {
            return new LibraryFormDto { Title = Title, Description = Description };
        }
